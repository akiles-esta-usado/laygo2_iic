...
for celltype in cell_type:
   for nf in nf_list:
      ...
      laygo2.interface.magic.export(lib, filename=ref_dir_MAG_exported +libname+'_'+cellname+'.tcl', cellname=None, libpath=paths.magic_layout_libpath, scale=1, reset_library=False, tech_library='sky130A')
